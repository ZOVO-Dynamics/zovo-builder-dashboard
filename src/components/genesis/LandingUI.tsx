      ...
      <main className="relative z-10 flex-1 flex flex-col items-center px-6">
        ...
        <div className="flex flex-col items-center justify-center w-full pt-10 pb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <a
              href="/login"
              className="px-8 py-4 bg-white text-black rounded-2xl font-bold text-sm tracking-wide hover:scale-105 active:scale-95 transition-all shadow-xl"
            >
        ...
        <motion.section {...FADE_UP} className="w-full max-w-3xl py-24 border-t border-white/5 text-center">
          ...
          <a
            href="/login"
            className="inline-block px-10 py-4 bg-white text-black rounded-2xl font-bold text-sm tracking-wide hover:scale-105 active:scale-95 transition-all shadow-xl"
          >
