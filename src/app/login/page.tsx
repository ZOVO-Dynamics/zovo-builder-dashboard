...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-black text-white overflow-hidden flex items-center justify-center px-6">
      ...
      <AmbientParticles />
      <AmbientHalo className="w-[28rem] h-[28rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />

      <form
        onSubmit={handleSubmit}
        className="relative z-10 w-full max-w-sm space-y-4 p-8 rounded-2xl bg-neutral-900/60 backdrop-blur-md border border-amber-500/20 hover:border-amber-500/40 transition-all"
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-lg bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 disabled:from-zinc-700 disabled:via-zinc-700 disabled:to-zinc-700 text-black font-semibold px-4 py-2.5 text-sm shadow-[0_0_15px_rgba(245,158,11,0.25)] hover:scale-[1.02] active:scale-[0.98] transition-all"
        >
